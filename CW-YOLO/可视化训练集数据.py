...
test_data = torchvision.datasets.CIFAR10(root=r"D:\yolov8\YoloV8Source\ultralytics\cfg\datasets\CottenweedsID15", train=True, transform=torchvision.transforms.ToTensor())
