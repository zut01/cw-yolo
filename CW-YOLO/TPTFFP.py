...
if __name__ == '__main__':
    postfix = 'jpg'
    img_path = 'ultralytics/cfg/datasets/CottenweedsID15/images/test'
    label_path = 'ultralytics/cfg/datasets/CottenweedsID15/labels/test'
    predict_path = 'runs/detect/train41'
    save_path = 'vis'
    classes = ['lying','standing','eating' ,'walking']
